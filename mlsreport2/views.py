                ...
                try:
                    ...
                    for entry in data:
                        ...
                        PropertyInfo.objects.create(
                            ...
                            dir_cross_st=entry["property_info"]["Dir/Cross St"],
                            parking_drive_space=entry["property_info"]["Parking Drive Spaces"],
                            HST_applicable_to_sale_price=entry["property_info"]["HST Applicable to Sale Price"],
                            laundary_level= entry["property_info"]["Laundry Level"],
                            lot_size_source=entry["property_info"]["Lot Size Source"],
                            area=entry["property_info"]["area"],
                            municipality=entry["property_info"]["municipality"],
                            community=entry["property_info"]["community"],
                            rooms=entry["property_info"]["Rooms"],
                            bedrooms=entry["property_info"]["Bedrooms"],
                            washrooms=entry["property_info"]["Washrooms"],
                            kitchens=entry["property_info"]["kitchens"],
                            exteriors=entry["property_info"]["Exterior"],
                            roof=entry["property_info"]["Roof"],
                            foundation=entry["property_info"]["Foundation"],
                            garage_type=entry["property_info"]["Garage Type"],
                            garage_parking_spaces=entry["property_info"]["Garage Parking Spaces"],
                            basement=entry["property_info"]["Basement"],
                            water_front=entry["property_info"]["Waterfront"],
                        )
